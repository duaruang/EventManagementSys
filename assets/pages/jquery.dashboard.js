...
!function($) {
    ...
    Dashboard.prototype.init = function() {
        ...
        this.createStackedChart('morris-bar-stacked', $stckedData, 'y', ['a', 'b' ,'c'], ['Training', 'Exam', 'Others'], ['#3db9dc','#1bb99a', '#E1D250']);
        ...
        this.createDonutChart('morris-donut-example', $donutData, ['#3db9dc','#1bb99a', '#E1D250']);
    },
    //init
