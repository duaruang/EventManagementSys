...
<div id="title-kop">
	...
	<hr>
	<table cellspacing="0" width="100%" style="border:0;font-size: 12px;">
		<tr>
		...
		<tr>
			...
			<td style="text-align: left;">
				...
				Rencana Anggaran <br>
				<?php } ?>
				<?php if($jumlah_panitia !=0 ){ ?>
				Daftar Panitia <br>
				<?php } ?>
				<?php if($jumlah_pengajar !=0 ){ ?>
				Daftar Pengajar <br>
				<?php } ?>
			</td>
		</tr>
...
<div id="content" style="height: 550px;font-size: 12px;">
	<p>Dengan Hormat,</p>
	<p>Sehubungan dengan peningkatan kompetensi sumber daya manusia khususnya terkait dengan bisnis di lingkungan perusahaan, maka kami bermaksud mengadakan kegiatan pelatihan <strong><?php echo $nama_event; ?></strong> dengan topik <strong><?php echo $topik_event; ?></strong> dengan sasaran peserta karyawan <strong><?php echo replace_sasaran($sasaran); ?></strong> dengan kategori event <strong><?php echo $kategori_event; ?>.</strong></p>
	<p>Adapun kegiatan tersebut akan dilakukan pada tanggal <strong><?php echo tgl_indo_tanpa_detik($start_tanggal_p); ?></strong> bertempat di <strong>(<?php echo $kategori_tmp; ?>) <?php echo $nama_tempat; ?></strong> dan diikuti oleh peserta sebanyak <strong><?php echo $jumlah_peserta; ?> orang</strong>, <?php if($jumlah_pengajar==0){}else{ ?>jumlah Pengajar sebanyak <strong><?php echo $jumlah_pengajar; ?> orang</strong><?php } ?> <?php if($jumlah_panitia==0){}else{ ?> dan jumlah panitia sebanyak <strong><?php echo $jumlah_panitia; ?> orang</strong> <?php } ?> <?php if($jumlah_rab!=''){ ?>dengan Rencana Anggaran Biaya (RAB) sebesar <strong><?php echo $jumlah_rab; ?></strong><?php } ?> dan biaya tersebut menjadi beban Divisi PPL. </p>
...
<table cellspacing="0" width="100%" style="border:1px solid #000;text-align: center;font-size: 12px;">
		...
		<tr>
			...
			<td style="border: 1px solid #000;text-align: left;padding: 5px;">Henny Herawaty <br> Kepala Bagian Support Services</td>
