...
<div id="content" style="height: 550px;font-size: 12px;">
	<p>Dengan Hormat,</p>
	<p>Sehubungan dengan peningkatan kompetensi sumber daya manusia khususnya terkait dengan bisnis di lingkungan perusahaan, maka kami bermaksud mengadakan kegiatan pelatihan <strong><?php echo $nama_event; ?></strong> dengan topik <strong><?php echo $topik_event; ?></strong> dengan sasaran peserta karyawan <strong><?php echo $sasaran; ?></strong> dengan kategori event <strong><?php echo $kategori_event; ?> <?php echo $nama_tempat; ?></strong></p>
	<p>Adapun kegiatan tersebut akan dilakukan pada tanggal <strong><?php echo tgl_indo_tanpa_detik($start_tanggal_p); ?></strong> bertempat di <strong>(<?php echo $kategori_tmp; ?>) <?php echo $nama_tempat; ?></strong> dan diikuti oleh peserta sebanyak <strong><?php echo $jumlah_peserta; ?> orang</strong>, jumlah Pengajar sebanyak <strong><?php echo $jumlah_pengajar; ?> orang</strong> dan jumlah panitia sebanyak <strong><?php echo $jumlah_panitia; ?> orang</strong> dengan Rencana Anggaran Biaya (RAB) sebesar <strong><?php echo $jumlah_rab; ?></strong> dan biaya tersebut menjadi beban Divisi PPL. </p>
