...
<script>
	...
	jQuery(function($) {
		...
		$("#form-add-kategorievent").submit(function(e){
			e.preventDefault();
			
			var formURL = "<?php echo site_url('kategori-event/process_add'); ?>";
			...
			xhr.done(function(data) {
				...
				if(obj.result == 'OK')
				{
					window.location.href = '<?php echo site_url('kategori-event'); ?>';
				}
				if(obj.result == 'NG')
				{
					$("#loader").hide();
		...
		//Script: Edit Divisi
		$("#form-edit-kategorievent").submit(function(e){
			e.preventDefault();
			
			var formURL = "<?php echo site_url('kategori-event/process_edit'); ?>";
			var formDatas = new FormData(this);
			$("#loader").show();
			var xhr = $.ajax({
				url: formURL,
