...
<script>
	...
	jQuery(function($) {
		//Script: Tambah klasifikasi
		$("#form-add-klasifikasi").submit(function(e){
			e.preventDefault();
			
			var formURL = "<?php echo site_url('klasifikasi-materi/process_add'); ?>";
		...
		//Script: Edit klasifikasi
		$("#form-edit-klasifikasi").submit(function(e){
			e.preventDefault();
			
			var formURL = "<?php echo site_url('klasifikasi-materi/process_edit'); ?>";
			var formDatas = new FormData(this);
			$("#loader").show();
			var xhr = $.ajax({
				url: formURL,
