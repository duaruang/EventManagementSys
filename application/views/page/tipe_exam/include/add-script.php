...
<script>
	...
	jQuery(function($) {
		...
		$("#form-add-tipeexam").submit(function(e){
			e.preventDefault();
			
			var formURL = "<?php echo site_url('tipe-exam/process_add'); ?>";
			...
			xhr.done(function(data) {
				...
				if(obj.result == 'OK')
				{
					window.location.href = '<?php echo site_url('tipe-exam'); ?>';
				}
				if(obj.result == 'NG')
				{
					$("#loader").hide();
		...
		//Script: Edit Divisi
		$("#form-edit-tipeexam").submit(function(e){
			e.preventDefault();
			
			var formURL = "<?php echo site_url('tipe-exam/process_edit'); ?>";
			var formDatas = new FormData(this);
			$("#loader").show();
			var xhr = $.ajax({
				url: formURL,
