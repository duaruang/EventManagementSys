...
<script>
	...
	jQuery(function($) {
		//Script: Tambah tipe pelatihan
		$("#form-add-tipepelatihan").submit(function(e){
			e.preventDefault();
			
			var formURL = "<?php echo site_url('tipe-pelatihan/process_add'); ?>";
		...
		//Script: Edit tipe pelatihan
		$("#form-edit-tipepelatihan").submit(function(e){
			e.preventDefault();
			
			var formURL = "<?php echo site_url('tipe-pelatihan/process_edit'); ?>";
			var formDatas = new FormData(this);
			$("#loader").show();
			var xhr = $.ajax({
				url: formURL,
