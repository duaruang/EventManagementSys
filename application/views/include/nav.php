                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li><a href="<?php echo site_url(); ?>">Trainer</a></li>
                                    <li><a href="<?php echo site_url(); ?>">Materi</a></li>
                                    <li><a href="<?php echo site_url(); ?>">Kategori Event</a></li>
                                    <li><a href="<?php echo site_url(); ?>">Tipe Pelatihan</a></li>
                                    <li><a href="<?php echo site_url(); ?>">Cabang</a></li>
                                    <li><a href="<?php echo site_url(); ?>">Divisi</a></li>
                                </ul>
                            </li>
